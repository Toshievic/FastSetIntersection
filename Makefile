...
# srcファイルのパス
SRC_DIR = src
SRC_FILES_EXE = main.cpp $(SRC_DIR)/util_new.cpp $(SRC_DIR)/labeled_graph_new.cpp $(SRC_DIR)/query_new.cpp $(SRC_DIR)/planner_new.cpp $(SRC_DIR)/simple_executor.cpp # 問合せ処理用
