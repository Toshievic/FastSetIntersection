...
${exec_file} --input_dirpath ${DATASET_BASE_PATH}/ego_twitter --output_dirpath ${PWD}/data/ego_twitter --items agg_al
echo -e "\nAmazon"
rm -r ${PWD}/data/amazon
${exec_file} --input_dirpath ${DATASET_BASE_PATH}/amazon --output_dirpath ${PWD}/data/amazon --items agg_al
echo -e "\nweb-Google"
